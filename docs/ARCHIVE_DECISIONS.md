...
- Localization: frontmatter lang & translationSlug; JSON UI text.
- Components/Layout: Layout.astro with lang & hreflang; language switcher.
- SEO/Metadata: alternates, sitemap, RSS (deferred), proper lang tags.
- Authoring: Markdown with localized frontmatter; translation pairing.
